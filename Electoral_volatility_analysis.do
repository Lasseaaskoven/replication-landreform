...
generate change_vote_share= abs(voteshare - l.voteshare) 



collapse (sum) change_vote_share (mean) yr, by( county id)
 ...
 *Generate Pedersen index*
 generate pedersen_index= change_vote_share/2
...
bootstrap, cluster(county_n) rep(1000) seed(123): areg  pedersen_index c.post_reform##c.logvalue i.election_id  , absorb(county_n), if yr>1865 & yr<1940 & yr!=1915  & yr!=1918 & county_n!=6 & county_n!=21 & county_n!=24
bootstrap, cluster(county_n) rep(1000) seed(123): areg  pedersen_index c.post_reform##c.logvalue logpop i.election_id  , absorb(county_n), if yr>1865 & yr<1940 & yr!=1915 & yr!=1918 
bootstrap, cluster(county_n) rep(1000) seed(123): areg  pedersen_index c.post_reform##c.logvalue logpop urbanization  i.election_id  , absorb(county_n), if yr>1865 & yr<1940 & yr!=1915 & yr!=1918 
